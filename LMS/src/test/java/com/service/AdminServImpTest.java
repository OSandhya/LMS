...
class AdminServImpTest {
	...
	UsersRepository userrepo;
		...
		void testAddAdminDetails() {
		  ...
		  @Test void testValidateUserDetails() throws UserNotFoundException 
		  {
			  Users u=new Users();
				u.setUserid(1);
		...
		void testAddBooks() {
			...
			assertThat(adminservice.addBooksByAdmin(b1)).isEqualTo(b1);
		}
		...
		void testUpdateBooks() throws Throwable {
			...
			assertThat(adminservice.updateBooksByAdmin(b1)).isEqualTo(b1);
		}
		...
		void testAddBookorder() {
			...
			assertThat(adminservice.addBookOrderByAdmin(bo)).isEqualTo(bo);
		}
		...
		void testUpdateBookorder() throws Throwable {
			...
			bo.setOrderStatus("ordered");
			bo.setQuantity(2);
			assertThat(adminservice.updateBookOrderByAdmin(bo)).isEqualTo(bo);
		}
		...
		void testViewDamagedBooksList() {
			...
			assertThat(adminservice.viewDamagedBooksListByAdmin()).isEqualTo(damagedList);
		}
		...
		void testAddDamagedBooks() {
			...
			assertThat(adminservice.addDamagedBooksByAdmin(db)).isEqualTo(db);
		}

		 @Test void testSearchBookByTitleByAdmin() 
		  { 
			  Books b1 = new Books(); 
			  b1.setBookid((long)1); 
			  b1.setTitle("FairyTales"); 
		      ...
		      assertThat(adminservice.searchBookByTitleByAdmin("FairyTales")).isEqualTo(bookList); 
		  }
		  
		  @Test void testSearchBookBySubjectByAdmin() 
		  { 
			  Books b1 = new Books();
		      b1.setBookid((long) 1); 
		      b1.setTitle("FairyTales");
		      ...
		      assertThat(adminservice.searchBookBySubjectByAdmin("Cindrella")).isEqualTo(bookList); }
