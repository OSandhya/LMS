...
@SpringBootTest
class LoginServImpTest {

	@Autowired
	LoginServImp loginservice;
	@MockBean
	...
	void testViewusersbyid() throws Throwable {
	  ...
	  { 
		  Login l1=new Login();
			...
			List<Login> loginlist=new ArrayList<Login>();
			loginlist.add(l1);
			Mockito.when(loginrepo.findByusername("Sahithi")).thenReturn(loginlist);
			assertThat(loginservice.getByusername("Sahithi")).isEqualTo(loginlist);
	  }
